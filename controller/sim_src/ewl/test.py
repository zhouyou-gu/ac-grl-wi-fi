    ...
    for it in range(20):
        ...
        for it_it in range(1):
            ...
            for i in batch_idx:
                ...
                a = np.random.randn()*np.linalg.norm(out[i],ord=1)/n_out_dim
                out[i,j] += a
                d_interference.append(a)
                d_interference_idx.append(j)
            ...
            for b in range(batch_size):
                loss += (out_grad[b,d_interference_idx[b]] * (-(d_local/d_interference[b]/(local_old/n_solution))))
