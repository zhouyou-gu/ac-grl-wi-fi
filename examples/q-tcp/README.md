...
- Apply Q-Learning (SARSA) algorithm to TCP congestion control, for real-time changes in the environment of network transmission, by strengthening the learning management sliding window and threshold size, the network can get better throughputs and smaller delay.
...
| :------------------: | :-----------------------: | ------ |
| bottleneck_bandwidth | bottleneck link bandwidth | 10Mbps |
...
* Apply Q-learning (SARSA) algorithm to TCP congestion control
...
|      Parameter       |        TCP-NewReno        | Q-TCP  |
| :------------------: | :-----------------------: | ------ |
|    Throughput        |         2.22654 Mbps      |  2.26527 Mbps |
|    Delay             |         22 ms             |  25 ms |
